       ...
       // buscaTokenUsuario();
        ...
        function carregaCliente() {
            ...
            buscaCliente().then(cliente => {
                ...
                let campoD2C = document.getElementById('D2C');
                campoD2C.checked = cliente.D2C;
                campoD2C.disabled = true;

                let campoOmni = document.getElementById('Omni');
                campoOmni.checked = cliente.Omni;
                campoOmni.disabled = true;
        ...
        function modificar() {
                ...
                let campoD2C = document.getElementById('D2C');
                campoD2C.disabled = false;

                let campoOmni = document.getElementById('Omni');
               campoOmni.disabled = false;
